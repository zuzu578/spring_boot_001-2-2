...
<body>
	<div class="docForm">
		<form action="doMakingDoc" method="post" enctype="multipart/form-data" id="frm">
			<h3>문서 작성하기</h3>
			<div class="input-group mb-3">
				<span class="input-group-text" id="basic-addon1">노래제목</span> <input
					type="text" name="songName" id="songName" class="form-control"
			...
			<div class="input-group mb-3">
				<span class="input-group-text" id="basic-addon1">수록 버전 </span> <input
					type="text" class="form-control" id="musicVersion"
			...
			<div class="input-group mb-3">
				<span class="input-group-text" id="basic-addon1">유튜브 iframe
					code </span> <input type="text" class="form-control" id="youtubeUrl"
