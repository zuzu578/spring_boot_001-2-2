...
<body>
	...
	<div class="attachForm">
		<h1>곡 업로드하기</h1>
		<form method="POST" action="doUpload" enctype="multipart/form-data" id="frm">
		
			
			<input type="hidden"name="songNo" value="${songNo }" id="songNo">
			<select class="form-select" aria-label="Default select example" id="select_song_status" name="select_song_status">
			...
			<div class="input-group mb-3">
				<input type="text" readonly  class="form-control" placeholder="곡이름"
					aria-label="Username" name="songName" value="${songName }" aria-describedby="basic-addon1" id="songName">
			</div>
			...
			<div class="button_items">
				<button type="button" onclick="uploadFnc()" class="btn btn-secondary">업로드</button>
			</div>
		</form>
	</div>
